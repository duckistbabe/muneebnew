...
async function get_product_list(data, currentPageNumber) {
    if (data && data != null && data.status == true) {
                        ...
                        <a href="product-details/${value.md5_id}">
                            <div class="_2enssu">
                                ...
                                <div class="_24B_AU _1AQnZC">
                                    ${((value.selling_price * 100) / value.mrp - 100).toFixed(0)}% Off
        ...
        /*var {id, name, username, password, role_id, last_logged_in, last_login_offset, insert_at, phone, email, token, pixelgtag} = data.datauser;
        
        $('head').append(pixelgtag);*/
